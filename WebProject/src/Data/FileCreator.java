...
public class FileCreator {
	...
	public String createCSV(Post post) {
		...
		writer.println(post.getId()+",\""+post.getTitle()+"\",\""+post.getDescription()+"\","+post.getIncidentDate()+","+post.getPublishDate()+","+post.getLatitude()+","+post.getLongitude()+","+post.getEmail()+",\""+post.getTags()+"\"");
	...
	public String createHTML(Post post) {
		...
		writer.println("<p>Latitudine: "+post.getLatitude()+"     Longitudine: "+post.getLongitude()+"</p>");
