...
<body>
	<nav>
		<ul id="navigationMenu">
			<li><a class="unverifiedPost" href="admin_data.jsp"> <span>Unverified
						posts</span></a>
			</li>
			<li><a class="verifiedPost" href="admin_data_posted.jsp"> <span>Verified
						posts</span></a>
			</li>
		</ul>
	</nav>
	<div class="content">
		...
		<ul class="raport">
			...
			<li><strong>Submitted by: </strong> <%=post.getEmail()%>
			</li>
			<li>
				<p>
					<%=post.getDescription()%>
			...
			<li class="buttons"><a
				href="RejectHandler?index=<%= post.getId() %>&table=valid"><img
					class="shortcut" src="img/mark-bad.jpg" alt="decline"></a></li>
		</ul>
	</div>
